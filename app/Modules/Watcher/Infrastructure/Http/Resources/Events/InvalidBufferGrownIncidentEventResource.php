 ...
 * the end of the list.
 */
class InvalidBufferGrownIncidentEventResource extends AbstractApiResource
{
    private string $id;
    private string $incident_id;
    private string $occurred_at;
    private ?InvalidBufferGrownEventPayloadResource $payload;
    ...
    public function __construct(WatcherIncidentEventObject $resource)
    {
        ...
        $this->payload = $resource->payload instanceof InvalidBufferGrownEventPayloadObject
            ? new InvalidBufferGrownEventPayloadResource($resource->payload)
            : null;
    }
}
