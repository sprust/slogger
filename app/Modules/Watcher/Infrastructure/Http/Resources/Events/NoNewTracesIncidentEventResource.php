 ...
 * the end of the list.
 */
class NoNewTracesIncidentEventResource extends AbstractApiResource
{
    private string $id;
    private string $incident_id;
    private string $occurred_at;
    private ?NoNewTracesEventPayloadResource $payload;
    ...
    public function __construct(WatcherIncidentEventObject $resource)
    {
        ...
        $this->payload = $resource->payload instanceof NoNewTracesEventPayloadObject
            ? new NoNewTracesEventPayloadResource($resource->payload)
            : null;
    }
}
