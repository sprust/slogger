...
class LogErrorsIncidentEventResource extends AbstractApiResource
{
    private string $id;
    private string $incident_id;
    private string $occurred_at;
    private ?LogErrorsEventPayloadResource $payload;
    ...
    public function __construct(WatcherIncidentEventObject $resource)
    {
        ...
        $this->payload = $resource->payload instanceof LogErrorsEventPayloadObject
            ? new LogErrorsEventPayloadResource($resource->payload)
            : null;
    }
}
