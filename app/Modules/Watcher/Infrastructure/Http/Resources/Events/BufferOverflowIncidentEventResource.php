 ...
 * the end of the list.
 */
class BufferOverflowIncidentEventResource extends AbstractApiResource
{
    private string $id;
    private string $incident_id;
    private string $occurred_at;
    private ?BufferOverflowEventPayloadResource $payload;
    ...
    public function __construct(WatcherIncidentEventObject $resource)
    {
        ...
        $this->payload = $resource->payload instanceof BufferOverflowEventPayloadObject
            ? new BufferOverflowEventPayloadResource($resource->payload)
            : null;
    }
}
