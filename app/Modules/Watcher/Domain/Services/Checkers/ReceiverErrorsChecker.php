...
readonly class ReceiverErrorsChecker implements WatcherCheckerInterface
{
    public const int MAX_MESSAGE_LENGTH = 500;

    public function __construct(
        private FindReceiverErrorStatAction $findReceiverErrorStatAction,
    ...
    public function check(WatcherObject $watcher, WatcherCheckContextObject $context): ?WatcherEventPayloadInterface
    {
        ...
        $stat = $this->findReceiverErrorStatAction->handle($since, $context->now);
