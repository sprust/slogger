 ...
 *
 * ShouldRescue: the index is built either way. A bus that is down must cost the waiting
 * request its timeout, not cost the build pass the rest of its batch.
 */
class TraceDynamicIndexBuiltBroadcast implements ShouldBroadcastNow, ShouldRescue
{
