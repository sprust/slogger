...
/**
 * Generated from protobuf message <code>collector.TraceUpdateObject</code>
 */
class TraceUpdateObject extends \Google\Protobuf\Internal\Message
{
    ...
    protected $status = '';
    /**
     * Generated from protobuf field <code>.collector.TraceProfilingItemsObject profiling = 3;</code>
     */
    protected $profiling = null;
    /**
     * Generated from protobuf field <code>.collector.TagsObject tags = 4;</code>
     */
    protected $tags = null;
    /**
     ...
     *     @type string $status
     *     @type \GRPC\Collector\TraceProfilingItemsObject $profiling
     *     @type \GRPC\Collector\TagsObject $tags
    ...
    /**
     * Generated from protobuf field <code>.collector.TraceProfilingItemsObject profiling = 3;</code>
     * @return \GRPC\Collector\TraceProfilingItemsObject
     */
    ...
    /**
     * Generated from protobuf field <code>.collector.TraceProfilingItemsObject profiling = 3;</code>
     * @param \GRPC\Collector\TraceProfilingItemsObject $var
     * @return $this
     */
    public function setProfiling($var)
    {
        GPBUtil::checkMessage($var, \GRPC\Collector\TraceProfilingItemsObject::class);
        $this->profiling = $var;
    ...
    /**
     * Generated from protobuf field <code>.collector.TagsObject tags = 4;</code>
     * @return \GRPC\Collector\TagsObject
     */
    ...
    /**
     * Generated from protobuf field <code>.collector.TagsObject tags = 4;</code>
     * @param \GRPC\Collector\TagsObject $var
     * @return $this
     */
    public function setTags($var)
    {
        GPBUtil::checkMessage($var, \GRPC\Collector\TagsObject::class);
        $this->tags = $var;
