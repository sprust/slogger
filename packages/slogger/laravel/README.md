...
SLOGGER_QUEUE_TRACES_PUSHING_NAME=slogger

## slogger.queues.transporter
SLOGGER_TRANSPORTER_QUEUE_CONNECTION=${QUEUE_CONNECTION}
SLOGGER_TRANSPORTER_QUEUE_NAME=slogger-transporter
