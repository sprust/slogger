...
class TraceProfilingItemObject extends \Google\Protobuf\Internal\Message
{
     ...
     *     @type \GRPC\TraceCollector\TraceProfilingItemDataItemObject[]|\Google\Protobuf\Internal\RepeatedField $data
     * }
     */
    ...
    /**
     * Generated from protobuf field <code>repeated .trace.collector.TraceProfilingItemDataItemObject data = 4;</code>
     * @param \GRPC\TraceCollector\TraceProfilingItemDataItemObject[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setData($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \GRPC\TraceCollector\TraceProfilingItemDataItemObject::class);
        $this->data = $arr;
