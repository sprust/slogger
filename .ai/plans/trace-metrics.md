...
- `DashboardMetricsServiceChart.vue` — график сервиса: столбцы, три серии по 96
  ...
  высота с заглушкой, пока не загружен; клик по столбцу открывает агрегатор с сервисом,
  выбранными типами и 15-минуткой столбца (`traceAggregatorStore.applyExternalFilter`);
